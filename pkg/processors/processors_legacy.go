...
// var (
// 	_GUIDE_SEQUENCE = "CTAATAGGAGAGTATGCTGATGG"
// 	_ALLOW_N        = false
// )
//
// func _ComparePatterns(pattern1 []uint64, pattern2 []uint64, config *models.PatternConfig) bool {
// 	totalMismatches := 0
...
// // }
//
// func _ProcessFastaRecordChunks(targetPattern []uint64, config *models.PatternConfig, fastaRecordChunksChan <-chan *pools.FastaRecordChunk, matcedPatternChan chan<- *pools.MatchedPattern) {
...
//
// 			// fmt.Println("Segments", slidingWindow.Segments, "\tSequence:", slidingWindow.GetSequence())
// 			if _ComparePatterns(slidingWindow.Segments, targetPattern, config) {
...
// 				matchedPattern.GuideSequence = _GUIDE_SEQUENCE
...
// }
//
// func _ProcessResults(matcedPatternChan <-chan *pools.MatchedPattern) {
